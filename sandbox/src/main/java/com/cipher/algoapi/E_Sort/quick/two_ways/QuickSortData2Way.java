package com.cipher.algoapi.E_Sort.quick.two_ways;
 ...
 */
public class QuickSortData2Way {
    ...
    public QuickSortData2Way(int N, int randomBound, Type dataType) {
        numbers = new int[N];
    ...
    public QuickSortData2Way(int N, int randomBound) {
